...
subjectSelect.addEventListener('change', () => {
  ...
  deleteSubjectBtn.style.display = subject && isAdmin ? 'inline-block' : 'none';
  deleteChapterBtn.style.display = 'none';
  deleteQuestionBtn.style.display = 'none';
  editQuestionBtn.style.display = 'none';
...
chapterSelect.addEventListener('change', () => {
  ...
  deleteChapterBtn.style.display = chapter && isAdmin ? 'inline-block' : 'none';
  deleteQuestionBtn.style.display = 'none';
  editQuestionBtn.style.display = 'none';
...
function enableAdminView() {
  ...
  deleteChapterBtn.style.display = 'inline-block';
...
// Ensure admin buttons are hidden initially if not logged in
if (!isAdmin) {
  disableAdminView();
}
